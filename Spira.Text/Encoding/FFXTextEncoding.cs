...
{
    public sealed class FFXTextEncoding : Encoding
    {
        private readonly FFXTextEncoder _encoder;
        private readonly FFXTextDecoder _decoder;

        public FFXTextEncoding(FFXTextEncodingCodepage codepage)
        {
            _encoder = new FFXTextEncoder(codepage);
            _decoder = new FFXTextDecoder(codepage);
        }
